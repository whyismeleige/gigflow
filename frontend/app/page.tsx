          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Post your project in minutes and start receiving quality bids
                from freelancers
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Access a global pool of skilled professionals ready to bring
                your ideas to life
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Get instant notifications when you receive bids or get hired for
                projects
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Built with security in mind to protect both clients and
                freelancers
              </p>
            </div>
          </div>
